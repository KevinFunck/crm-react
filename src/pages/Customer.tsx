...
export default function Customers({ customers, setCustomers }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <Dialog.Panel className="bg-gray-900 p-6 rounded-2xl shadow-lg max-w-md w-full text-white">
          ...
          <div className="mt-6 flex justify-end gap-2">
            <button onClick={() => setIsModalOpen(false)} className="px-4 py-2 bg-gray-700 rounded-lg">Cancel</button>
            <button onClick={handleSubmit} className="px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700">Save</button>
          </div>
        </Dialog.Panel>
      </Dialog>
      ...
      >
        <div className="fixed inset-0 bg-black/50" />
        <Dialog.Panel className="bg-gray-900 p-6 rounded-2xl shadow-lg max-w-sm w-full text-white">
          <Dialog.Title className="text-xl font-bold mb-4">Delete Company?</Dialog.Title>
          <p className="mb-6">
            Are you sure you want to delete <span className="font-semibold">{customerToDelete?.companyName}</span>?
          </p>
          <div className="flex justify-end gap-2">
            <button onClick={() => setIsDeleteModalOpen(false)} className="px-4 py-2 bg-gray-700 rounded-lg">Cancel</button>
            <button onClick={handleDelete} className="px-4 py-2 bg-red-600 rounded-lg hover:bg-red-700">Delete</button>
          </div>
        </Dialog.Panel>
      </Dialog>
    </div>
